...
<body class="p-12" style="background-color: <?php echo $colorFondo;?> ;">
    <h1 class="text-center text-2x1 font-bold"> Sitio de la empresa</h1>
...
<div class="mt-12 flex  p-6 border-4 shadow-x1 rounded-x1 justify-around">
        ...
        <i class="fa-solid fa-user ml-2"></i>Portal Usuario
        </a>
        <?php   
        if($_SESSION['perfil']){
         echo  '<a href="admin.php" class="px-2 py-1 rounded text-white bg-purple-500 hover:bg-purple-700 font-bold">
           Portal Administrador  <i class="fa-solid fa-user-gear ml-2"></i>
        </a>';
        ...
        <a href="cerrar.php" 
        class="px-2 py-1 rounded text-white bg-blue-500 hover:bg-blue-700 font-bold">
        Cerrar Sesión <i class="fa-solid fa-door-open ml-2"></i>
        </a> 
</div>
</body>
